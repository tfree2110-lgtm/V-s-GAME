...
<body>
    <div id="game-wrapper">
        <button id="back-btn" class="hidden" onclick="goToMenu()">🏠</button>
        ...
        <div id="home-screen" class="overlay">
            <div class="kawaii-card">
                ...
                <button class="menu-btn" onclick="showLevelMenu()">START GAME 🎀</button>
            </div>
        </div>
        ...
        <div id="level-menu" class="overlay hidden">
            <div class="kawaii-card">
                ...
                <button class="menu-btn level-select" onclick="startGame('easy')">EASY</button>
                <button class="menu-btn level-select" onclick="startGame('medium')">MEDIUM</button>
                <button class="menu-btn level-select" onclick="startGame('hard')">HARD</button>
                <hr style="border: 1px dashed #ffb3d9; margin: 15px 0; width: 100%;">
                <button class="menu-btn restart-btn" onclick="fullReset()">RESTART PROGRESS 🗑️</button>
                <button class="menu-btn back-menu-btn" onclick="goToMenu()">BACK</button>
            </div>
        </div>
        ...
        <div id="win-screen" class="overlay hidden">
            <div class="kawaii-card">
                <div class="heart-icon pulse">❤️</div>
                <h2 id="win-title">LEVEL CLEAR!! ❤️</h2>
                <div id="message-box">
                    <p id="win-message"></p>
                </div>
                <button class="menu-btn" onclick="resetAndGoToMenu()">PLAY AGAIN 🎀</button>
            </div>
        </div>

        <div class="kawaii-header">
            <div class="ribbon">🎀 VICTORIA'S WORD GAME 🎀</div>
            <div id="bonus-counter" class="hidden">Bonus Words: 0</div>
        </div>
        
        <div id="success-popup">GOOD JOB ❤️</div>
        <div id="found-words-container"></div>
        <div id="preview-box"><span id="word-preview"></span></div>

        <div id="interaction-area">
            <button id="hint-btn" class="hidden" onclick="useHint()">💡</button>
            <button id="shuffle-btn" class="hidden" onclick="shuffleLetters()">🔄</button>
